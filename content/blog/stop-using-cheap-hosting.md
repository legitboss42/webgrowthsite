...
<figure className="my-12">
  <img src="/images/blog/cloudways-stack.png" alt="The Cloudways ThunderStack Architecture" width="100%" height="auto" class="rounded-lg border border-emerald-900/50 shadow-lg shadow-emerald-900/20" />
  <figcaption class="text-center text-sm text-gray-500 mt-4">The Engineering Stack Behind the Speed</figcaption>
</figure>
...
<figure className="my-12">
  <img src="/images/blog/speed-comparison.png" alt="Speed Comparison Graph: Shared vs Cloud" width="100%" height="auto" class="rounded-lg border border-emerald-900/50 shadow-lg shadow-emerald-900/20" />
  <figcaption class="text-center text-sm text-gray-500 mt-4">Average TTFB: Shared Hosting vs. Cloudways</figcaption>
</figure>
...
<LeadMagnet action="https://assets.mailerlite.com/json/p/view/YOUR_FORM_ID/content" file="/downloads/server-migration-checklist.pdf" />
