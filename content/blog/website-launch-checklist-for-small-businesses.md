...
No clear CTA, no launch.  
No speed baseline, no launch.
...
Use this full [small business SEO checklist](/blog/small-business-website-seo-checklist) before publishing any major new page.
...
For local visibility, follow the [Google Maps ranking guide](/blog/local-seo-for-small-business-google-maps-ranking-guide).
...
1. Final backup of old site
2. Push new site live
3. Re-check SSL and redirects
4. Smoke-test forms and CTAs
5. Submit sitemap to Search Console
6. Verify analytics events
7. Announce launch (email/social)
