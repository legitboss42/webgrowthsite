...
steps:
  - "Define offer and audience in one-page brief."
  - "Map copy by section purpose (trust, clarity, action)."
  - "Prepare proof and FAQ inputs before development."
relatedGuideSlugs:
  - "homepage-structure-that-converts-visitors-into-customers"
  - "landing-page-wireframe-local-service-business"
faq:
  - question: "Do I need final polished copy before design starts?"
    answer: "No, but you need structured draft inputs and clear messaging priorities."
  - question: "Can developers write all copy?"
    answer: "Developers can guide structure, but business context and offer detail should come from you."
ctaVariant: consultation
evidenceNote: "Based on recurring delays caused by weak copy preparation before build kickoff."
methodologyNote: "Framework prioritizes speed, clarity, and conversion alignment."
---
...
- [Landing Page Wireframe for a Local Service Business](/blog/landing-page-wireframe-local-service-business)
