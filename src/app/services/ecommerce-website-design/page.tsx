    ...
    <>
      ...
      <main className="relative overflow-x-clip bg-black text-white">
        ...
        <SocialProofSection
          ...
          description="Explore selected Web Growth website builds, online store concepts, and conversion-focused layouts without relying on invented results or fake proof."
        />
