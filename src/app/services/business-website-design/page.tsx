    ...
    <>
      ...
      <main className="relative overflow-x-clip bg-black text-white">
        ...
        <SocialProofSection
          ...
          description="Explore selected Web Growth website builds, redesign concepts, and conversion-focused layouts without relying on invented results or exaggerated claims."
        />
