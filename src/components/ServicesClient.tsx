      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            <div>
              <div className="text-sm tracking-[0.25em] text-white/50">SERVICES</div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {services.map((s) => {
              ...
              const img =
                s.image ? urlFor(s.image).width(900).height(700).url() : "/images/services/services-audit.png";
                ...
                >
                  <div className="grid md:grid-cols-5">
                    ...
                    <div className="md:col-span-3 p-7">
                      ...
                      <p className="mt-3 text-white/70 leading-relaxed">{s.short}</p>
