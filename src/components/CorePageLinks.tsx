...
export default function CorePageLinks({
  ...
  return (
    <section className="relative overflow-hidden border-b border-slate-200 bg-[#eff1ec] py-14">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_20%,rgba(28,122,84,0.06),transparent_32%),radial-gradient(circle_at_82%_72%,rgba(180,128,47,0.08),transparent_28%)]" />
