...
// invalid zones, or non-future instants from a crafted request.
test("schedule boundary rejects offset-free, invalid-zone, and non-future input", () => {
  for (const input of [
    { scheduledFor: "2026-08-24T14:00", timezone: "Africa/Lagos", nowIso: "2026-08-24T12:00:00.000Z", error: "Choose a future time and timezone." },
    { scheduledFor: "2026-08-24T14:00:00+01:00", timezone: "Not/A_Timezone", nowIso: "2026-08-24T12:00:00.000Z", error: "Timezone is invalid." },
    { scheduledFor: "2026-08-24T12:00:00Z", timezone: "Africa/Lagos", nowIso: "2026-08-24T12:00:00.000Z", error: "Choose a future time and timezone." },
  ]) {
